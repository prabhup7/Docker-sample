...
The purpose of this project is to setup a [Docker enviroment] on your machine and to start off with [Flask](http://flask.pocoo.org/) micro webservice-framework for Python.
...
* [1] Install [Docker]
* [2] Create a Github repo called "example1" and clone the repo to your local machine.
...
* [6] Run this command inside the example1 working directory. Make sure you have all these files in the current directory: Dockerfile, app.py, and requirements.txt
```sh
docker build -t example1-app:latest .
```
...
```sh
docker run -d -p 5000:5000 example1-app
```

* [9] Lookup IP of the example1-app container.
```sh
docker-machine ls
# OR 
